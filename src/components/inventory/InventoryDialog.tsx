  ...
  const inventoryItems = [
    {
      ...
      field: "bibles" as keyof Omit<Inventory, "lastResetDate">,
      icon: Book,
    ...
    },
    {
      ...
      field: "magazines" as keyof Omit<Inventory, "lastResetDate">,
      icon: BookOpen,
    ...
    },
    {
      ...
      field: "offerings" as keyof Omit<Inventory, "lastResetDate">,
      icon: DollarSign,
